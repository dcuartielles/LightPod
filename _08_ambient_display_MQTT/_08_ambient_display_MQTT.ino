...
// timer for the connectivity part of the codebase
...
void setup() {
  ...
  // initialize the classes having to do with connectivity
  WiFi.begin(ssid, pass);
  client.begin("a1y7d41s0oj85v.iot.us-east-1.amazonaws.com", 8883, net);

  // connect to the different things out there
  //connect();
}

void loop() {
  // make sure the connectivity keeps on working
  client.loop();
